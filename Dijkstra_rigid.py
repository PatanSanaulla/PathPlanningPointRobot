...
class step:
	...
	def addToGraph(self):
		if self.position in STEPS_LIST:
			...
			updateTheStep(self.position, startColor, RADIUS)
...
if isPossible == 2: 
	updateTheStep(START_POINT, startColor, RADIUS) #Step to highlight the start point
	updateTheStep(GOAL_POINT, goalColor, RADIUS) #Step to highlight the Goal point
